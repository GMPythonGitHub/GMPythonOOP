...
import copy
from gm_cta06_OOP_truss_adv0_node_wght import (GMTrussNode)
...
class GMTrussMember():
    ...
    def __init__(self,
            ...
            rhos: float = 0, grac: float = 9.80665, cnv: bool = True ):
        ...
        self.set_truss_member(area=area, yong=yong, rhos=rhos, grac=grac, cnv=cnv )
...
if __name__ == '__main__':
    ...
    memb_0 = GMTrussMember(nodea=node_0, nodeb=node_1, rhos=rhos, grac=grac)
    memb_1 = GMTrussMember(nodea=node_1, nodeb=node_2, rhos=rhos, grac=grac)
