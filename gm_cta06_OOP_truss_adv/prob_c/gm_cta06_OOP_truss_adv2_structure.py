# gm_cta06_OOP_truss_adv2_structure.py: coded by Kinya MIURA 240530
# ---------------------------------------------------------
...
from gm_cta06_OOP_truss_adv1_member import (GMTrussNode, GMTrussMember)
...
class GMTrussStructure():
    ...
    def solv_matrixeq(self) -> None:  # solving matrix equation
        ...
        self._exfc = inner(self._stif, self._disp)
