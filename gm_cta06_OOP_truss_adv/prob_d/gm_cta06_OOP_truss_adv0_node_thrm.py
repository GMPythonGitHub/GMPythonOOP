# gm_cta06_OOP_truss_adv0_node_wght.py: coded by Kinya MIURA 230524
# ---------------------------------------------------------
...
class GMTrussNode(GMPoint):  # inheriting class GMPoint(GMVector)
    ...
    def __init__(self,
        ...
        self._wght = GMVector(xxyy=(0., 0.), unit=1e+3)  # (kN)
        self._thrm = GMVector(xxyy=(0., 0.), unit=1e+3)  # (kN)
    ...
    def printclass(self, idx: str = '') -> None:
        print(
            ...
            + '  wght: GMVector (kN): ' + self._wght.__str__() + '\n'
            + '  thrm: GMVector (kN): ' + self._thrm.__str__() + '' )
